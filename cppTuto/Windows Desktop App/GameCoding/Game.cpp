...
void Game::Init(HWND hwnd)
{
	...
	_bmpBack = ::CreateCompatibleBitmap(_hdc, _rect.right, _rect.bottom);	// hdc와호환되는 비트맵 생성
...
void Game::Render()
{
	...
	// Double Buffering (모두 그려진 상태)
	::BitBlt(_hdc, 0, 0, _rect.right, _rect.bottom, _hdcBack, 0, 0, SRCCOPY);	// 비트블릿 : 고속복사
